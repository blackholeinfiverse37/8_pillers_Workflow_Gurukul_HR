...
class Settings(BaseSettings):
    ...
    # Integration URLs (9-Pillar System)
    CORE_URL: str = os.getenv("CORE_URL", "http://localhost:8002")
    BUCKET_URL: str = os.getenv("BUCKET_URL", "http://localhost:8001")
    KARMA_URL: str = os.getenv("KARMA_URL", "http://localhost:8000")
    INSIGHT_CORE_URL: str = os.getenv("INSIGHT_CORE_URL", "http://localhost:8005")
    INSIGHT_FLOW_URL: str = os.getenv("INSIGHT_FLOW_URL", "http://localhost:8006")
    
    # Feature Flags
    ENABLE_CORE_INTEGRATION: bool = os.getenv("ENABLE_CORE_INTEGRATION", "true").lower() == "true"
    ENABLE_BUCKET_INTEGRATION: bool = os.getenv("ENABLE_BUCKET_INTEGRATION", "true").lower() == "true"
    ENABLE_KARMA_INTEGRATION: bool = os.getenv("ENABLE_KARMA_INTEGRATION", "true").lower() == "true"
    ...
    EMS_DEFAULT_SCHOOL_ID: Optional[int] = 1  # Default school ID if not using admin auth
