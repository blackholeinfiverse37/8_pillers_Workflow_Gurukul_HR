...
| EMS Backend | 8008 | http://localhost:8008 |
...
# Start EMS Backend
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'EMS System'; uvicorn app.main:app --host 0.0.0.0 --port 8008 --reload"
...
Write-Host "EMS Backend: http://localhost:8008"
